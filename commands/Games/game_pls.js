  ...
  async execute(interaction) {
    ...
    try {
      ...
      if (!taggedUser.presence) {
        ...
        const urlsearch = `https://search.icons8.com/api/iconsets/v4/search?term=${act_to_search}-logo&amount=20&offset=0&platform=al&token=YMqw87VqiFXGKeStTwAQux2iX37tPM92nMQ4dhpC`;
  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then((m) => {
        ...
        iconf = urlrequest;
        console.log(`HTTPS STATUS: ${statusCode} Icon: ${iconf}`);
